...
let no1 = document.querySelector('no2');
let no1 = document.querySelector('no3');
let no1 = document.querySelector('no4');
let no1 = document.querySelector('no5');
let no1 = document.querySelector('no6');
